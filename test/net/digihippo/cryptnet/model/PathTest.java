...
public class PathTest
{
    private final Segment one = new Segment(
            VertexBuilder.at(new LatLn(0.1214D, 1.224D)),
            VertexBuilder.at(new LatLn(0.1215D, 1.224D))
    );
    private final Segment two = new Segment(
            VertexBuilder.at(new LatLn(0.1215D, 1.224D)),
            VertexBuilder.at(new LatLn(0.1216D, 1.224D))
    );
    private final Segment three = new Segment(
            VertexBuilder.at(new LatLn(0.1216D, 1.224D)),
            VertexBuilder.at(new LatLn(0.1216D, 1.225D))
    );
    private final Segment four = new Segment(
            VertexBuilder.at(new LatLn(0.1216D, 1.225D)),
            VertexBuilder.at(new LatLn(0.1218D, 1.227D))
    );
