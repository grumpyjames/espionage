...
//    private final Segment segmentOne = Segment.createLine(0, 10, 5, 5);
//    private final Path pathOne = new Path(Collections.singletonList(segmentOne));
//    private final Segment segmentTwo = Segment.createLine(5, 5, 5, 10);
//    private final Path pathTwo = new Path(Collections.singletonList(segmentTwo));
...
//    {
//        Segment one = Segment.createLine(new Pixel(0, 0), new Pixel(0, 1));
//        Segment two = Segment.createLine(new Pixel(0, 1), new Pixel(1, 1));
//        Segment three = Segment.createLine(new Pixel(1, 1), new Pixel(1, 0));
//        Segment four = Segment.createLine(new Pixel(1, 0), new Pixel(0, 0));
//
...
//        final Random random)
//    {
//        DoublePoint point = patrol.location;
//        for (int i = 0; i < 50; i++)
//        {
//            patrol.tick(intersections, random, events);
//            assertThat(patrol.path.distanceTo(patrol.location), lessThan(1.0D));
//            assertThat(DoublePoint.distanceBetween(point, patrol.location), greaterThan(0.9D));
//            point = patrol.location;
//        }
//    }
//
//    @Test
...
//    {
//        Patrol patrol = new Patrol(
//            ident, pathTwo, segmentTwo, new DoublePoint(0, -1), new DoublePoint(5, 8), Direction.Forwards);
//
//        Random random = new Random(22357L);
...
//    {
//        Patrol patrol = new Patrol(
//            ident, pathOne, segmentOne, new DoublePoint(1, 0), new DoublePoint(3, 5), Direction.Forwards);
...
//            "\t   \"segment\": \"(284,27)->(287,22)\",\n" +
//            "\t   \"velocity\": \"(0.5144957554275265, -0.8574929257125441)\",\n" +
//            "\t   \"location\": \"(284.5294117647059, 26.11764705882348)\",\n" +
//            "\t   \"direction\": \"Forwards\",\n" +
//            "\t   \"previous\": \"null\",\n" +
//            "\t   \"previousTurn\": \"null\"\n" +
//            "}";
